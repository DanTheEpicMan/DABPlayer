...
Future<void> _updatePantryTimestampGlobal(double positionInSeconds) async {
  ...
  try {
    ...
    print("Pantry timestamp updated for $deviceNameVar in $currMP3 to $positionInSeconds s.");
  } catch (e, s) {
...
class _MainState extends State<Main> {
  ...
  Future<void> _saveNote(String noteText) async {
    ...
    if (trimmedText.isNotEmpty) {
      ...
      final newNote = "$timeStr-$deviceNameVar: $trimmedText";
      if (!mounted) return;
      setState(() {
